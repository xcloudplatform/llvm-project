...
entry:
; CHECK-LABEL: lshr8:
; CHECK: rsh64 r0, r2 # encoding: [0x7f,0x20,0x00,0x00,0x00,0x00,0x00,0x00]
  %shr = lshr i8 %a, %cnt
  ret i8 %shr
}
...
entry:
; CHECK-LABEL: ashr8:
; CHECK: arsh64 r0, r2 # encoding: [0xcf,0x20,0x00,0x00,0x00,0x00,0x00,0x00]
  %shr = ashr i8 %a, %cnt
  ret i8 %shr
}
...
entry:
; CHECK: shl8
; CHECK: lsh64 r0, r2 # encoding: [0x6f,0x20,0x00,0x00,0x00,0x00,0x00,0x00]
  %shl = shl i8 %a, %cnt
  ret i8 %shl
}
...
entry:
; CHECK-LABEL: shl64:
; CHECK: mov64 r0, r1 # encoding: [0xbf,0x10,0x00,0x00,0x00,0x00,0x00,0x00]
; CHECK: lsh64 r0, r2 # encoding: [0x6f,0x20,0x00,0x00,0x00,0x00,0x00,0x00]
; CHECK: exit # encoding: [0x95,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
  %shl = shl i64 %a, %cnt
  ret i64 %shl
