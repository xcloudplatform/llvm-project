//===- SBFCORE.h - Common info for Compile-Once Run-EveryWhere  -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_SBF_SBFCORE_H
#define LLVM_LIB_TARGET_SBF_SBFCORE_H
