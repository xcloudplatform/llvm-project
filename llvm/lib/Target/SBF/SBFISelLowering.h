//===-- SBFISelLowering.h - SBF DAG Lowering Interface ----------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_SBF_SBFISELLOWERING_H
#define LLVM_LIB_TARGET_SBF_SBFISELLOWERING_H
...
class SBFTargetLowering : public TargetLowering {
  const SBFSubtarget *Subtarget;
public:
  explicit SBFTargetLowering(const TargetMachine &TM, const SBFSubtarget &STI);
...
private:
  ...
  // type Ty1 to type Ty2. e.g. On SBF at alu32 mode, it's free to truncate
